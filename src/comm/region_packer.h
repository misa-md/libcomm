...
namespace comm {
   ...
   */
  template <typename T, typename RT> class RegionPacker {
  public:
     ...
     * \return
     */
    virtual const unsigned long sendLength(const std::vector<comm::Region<RT>> send_regions, const int dimension,
     ...
     * \param direction DIR_LOWER or DIR_HIGHER, the direction id.
     */
    virtual void onSend(T buffer[], const std::vector<comm::Region<RT>> send_regions, const unsigned long send_len,
