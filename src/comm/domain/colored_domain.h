...
namespace comm {
  ...
  public:
     ...
     * each region is indexed by high/low flag, for example, binary (X_HIGH | Y_LOW | Z_HIGH) represents the region
     * (1,0,1)
     */
  ...
  public:
     ...
     * \return
     */
    ColoredDomain *localBuild(const int _grid_size[DIMENSION_SIZE], const int _grid_coord[DIMENSION_SIZE]) override;
