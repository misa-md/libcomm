...
namespace comm {
  ...
  public:
     ...
     */
    BccDomain(const std::array<uint64_t, DIMENSION_SIZE> _phase_space, const double _lattice_const,
  ...
  public:
    ...
    BccDomain *localBuild(const int _grid_size[DIMENSION_SIZE], const int _grid_coord[DIMENSION_SIZE]) override;
