...
comm::type_region_array comm::fwCommSectorSendRegion(const _type_sector_id sector_id, const unsigned int dim,
  ...
  case DIM_X: // x dimension
    return regionsDimXSend(sector_id, ghost_size, local_box_region.x_low, local_box_region.y_low,
                           local_box_region.z_low, split_coord[0], split_coord[1], split_coord[2],
                           local_box_region.x_high, local_box_region.y_high, local_box_region.z_high);
  case DIM_Y: // y dimension
    return regionsDimYSend(sector_id, ghost_size, local_box_region.x_low, local_box_region.y_low,
                           local_box_region.z_low, split_coord[0], split_coord[1], split_coord[2],
                           local_box_region.x_high, local_box_region.y_high, local_box_region.z_high);
  case DIM_Z: // z dimension
    return regionsDimZSend(sector_id, ghost_size, local_box_region.x_low, local_box_region.y_low,
                           local_box_region.z_low, split_coord[0], split_coord[1], split_coord[2],
                           local_box_region.x_high, local_box_region.y_high, local_box_region.z_high);
  default:
    assert(false);
...
comm::type_region_array comm::fwCommSectorRecvRegion(const _type_sector_id sector_id, const unsigned int dim,
  ...
  switch (dim) {
  case DIM_X: // x dimension
    return regionsDimXRecv(sector_id, ghost_size, local_box_region.x_low, local_box_region.y_low,
                           local_box_region.z_low, split_coord[0], split_coord[1], split_coord[2],
                           local_box_region.x_high, local_box_region.y_high, local_box_region.z_high);
  case DIM_Y: // y dimension
    return regionsDimYRecv(sector_id, ghost_size, local_box_region.x_low, local_box_region.y_low,
                           local_box_region.z_low, split_coord[0], split_coord[1], split_coord[2],
                           local_box_region.x_high, local_box_region.y_high, local_box_region.z_high);
  case DIM_Z: // z dimension
    return regionsDimZRecv(sector_id, ghost_size, local_box_region.x_low, local_box_region.y_low,
                           local_box_region.z_low, split_coord[0], split_coord[1], split_coord[2],
                           local_box_region.x_high, local_box_region.y_high, local_box_region.z_high);
  default:
    assert(false);
...
comm::type_region_array comm::regionsDimXSend(const _type_sector_id sector_id,
                                              const _type_lattice_size g[DIMENSION_SIZE], const _type_lattice_coord xb,
                                              const _type_lattice_coord yb, const _type_lattice_coord zb,
                                              const _type_lattice_coord xc, const _type_lattice_coord yc,
                                              const _type_lattice_coord zc, const _type_lattice_coord xe,
                                              const _type_lattice_coord ye, const _type_lattice_coord ze) {
  switch (sector_id) {
  case 0: // sector 0
    return type_region_array{
...
comm::type_region_array comm::regionsDimYSend(const _type_sector_id sector_id,
                                              const _type_lattice_size g[DIMENSION_SIZE], const _type_lattice_coord xb,
                                              const _type_lattice_coord yb, const _type_lattice_coord zb,
                                              const _type_lattice_coord xc, const _type_lattice_coord yc,
                                              const _type_lattice_coord zc, const _type_lattice_coord xe,
...
comm::type_region_array comm::regionsDimZSend(const _type_sector_id sector_id,
                                              const _type_lattice_size g[DIMENSION_SIZE], const _type_lattice_coord xb,
                                              const _type_lattice_coord yb, const _type_lattice_coord zb,
                                              const _type_lattice_coord xc, const _type_lattice_coord yc,
                                              const _type_lattice_coord zc, const _type_lattice_coord xe,
...
comm::type_region_array comm::regionsDimXRecv(const _type_sector_id sector_id,
                                              const _type_lattice_size g[DIMENSION_SIZE], const _type_lattice_coord xb,
                                              const _type_lattice_coord yb, const _type_lattice_coord zb,
                                              const _type_lattice_coord xc, const _type_lattice_coord yc,
                                              const _type_lattice_coord zc, const _type_lattice_coord xe,
...
comm::type_region_array comm::regionsDimYRecv(const _type_sector_id sector_id,
                                              const _type_lattice_size g[DIMENSION_SIZE], const _type_lattice_coord xb,
                                              const _type_lattice_coord yb, const _type_lattice_coord zb,
                                              const _type_lattice_coord xc, const _type_lattice_coord yc,
                                              const _type_lattice_coord zc, const _type_lattice_coord xe,
...
comm::type_region_array comm::regionsDimZRecv(const _type_sector_id sector_id,
                                              const _type_lattice_size g[DIMENSION_SIZE], const _type_lattice_coord xb,
                                              const _type_lattice_coord yb, const _type_lattice_coord zb,
                                              const _type_lattice_coord xc, const _type_lattice_coord yc,
                                              const _type_lattice_coord zc, const _type_lattice_coord xe,
